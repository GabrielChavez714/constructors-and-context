...
/*
  ...
  e You'll also need to use the 'this' keyword properly in order to make sure you're
...
User.prototype.removeSavedPost = function (postId) {
  const removePost = this.savedPosts.findIndex((element) => {
...
User.prototype.changePostRating = function (id, newRating) {
  const updatedRating = this.savedPosts.findIndex((element) => {
